...
object Generator extends util.GeneratorApp {
  ...
  //FIXME: This code is copied from rocketchip/Generator.scala
  // Attempting to directly call its addTestSuites method results
  // in a null pointer. Jack and Adam stared at it for ~15 minutes
  // before giving up, so beware of trying to fix it yourself...
