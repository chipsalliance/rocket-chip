...
class CommitTraceMonitorBundle(val xLen: Int) extends Bundle with Clocked {
...
// mark a module that has cores with CommitTraceMonitorBundles
trait HasCommitTraceMonitorBundles {
    def commitTraceMonitorBundles: List[CommitTraceMonitorBundle]
}
