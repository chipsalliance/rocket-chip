...
object ClockGate {
  def apply[T <: ClockGate](in: Clock, en: Bool, name: Option[String] = None)(implicit p: Parameters): Clock = {
  ...
  def apply[T <: ClockGate](in: Clock, en: Bool, name: String)(implicit p: Parameters): Clock =
