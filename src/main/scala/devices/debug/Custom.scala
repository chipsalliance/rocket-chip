...
case class DebugCustomSource(snoopable: DebugCustomParams)(implicit valName: ValName)
...
case class DebugCustomNexusNode(
  ...
  outputRequiresInput: Boolean = true
    ...
    extends NexusNode(new DebugCustomImp)(sourceFn, sinkFn, inputRequiresOutput, outputRequiresInput)
