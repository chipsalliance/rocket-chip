    ...
    (node.in zip node.out) foreach { case ((in, edgeIn), (out, edgeOut)) =>
      ...
      val needW = in.a.bits.opcode =/= TLMessages.Get &&
                  (in.a.bits.opcode =/= TLMessages.AcquireBlock ||
                   ...
                   !edgeIn.manager.anySupportAcquireB.asBool)
      ...
      val d_rack  = edgeIn.manager.anySupportAcquireB.asBool && in.d.bits.opcode === TLMessages.ReleaseAck
      ...
      val d_grant = edgeIn.manager.anySupportAcquireB.asBool && deny.opcode === TLMessages.Grant
      ...
      if (edgeIn.manager.anySupportAcquireB) {
        ...
        val bypass = (edgeIn.manager.minLatency == 0).asBool && in.a.valid && in.a.bits.source === in.d.bits.source
