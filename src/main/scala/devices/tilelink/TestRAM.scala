...
class TLTestRAM(address: AddressSet, executable: Boolean = true, beatBytes: Int = 4, trackCorruption: Boolean = true)(
  ...
  lazy val module = new LazyModuleImp(this) {
    ...
    val wdata = Vec.tabulate(beatBytes) { i =>
...
class TLRAMZeroDelayTest(ramBeatBytes: Int, txns: Int = 5000, timeout: Int = 500000)(implicit p: Parameters)
