...
trait LazyScope
{
  ...
  def apply[T](body: => T) = {
    ...
    /** [[LazyModule.scope]] stack push. */
    LazyModule.scope = Some(this)
    /** Evaluate [[body]] is this scope, save the return to [[out]]. */
    val out = body
    /** Check the return scope is a right state. */
...
/** [[Dangle]] is generated by [[BaseNode.instantiate]] with [[MixedNode.danglesOut]] and [[MixedNode.danglesIn]] ,
  * let [[LazyModuleImp.instantiate]] making connection of them.
