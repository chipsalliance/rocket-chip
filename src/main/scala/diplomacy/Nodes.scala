...
{
  /** Creates the inward edge parameters by combining the downwards-flowing and upwards-flowing parameters for edges
  ...
  /** Defines how input parameters can be "mixed" or negotiated together.
    ...
    *
    * @param pu   upwards-flowing inward parameters
...
{
  /** Creates the outward edge parameters by combining the downwards-flowing and upwards-flowing parameters for edges
    * that connect to the outward side of this node.
    *
    * It is left up to a user defining a particular protocol implementation to decide how the parameters flowing through
    * the graph in both directions on this Edge are combined into a single representation.
    *
...
{
  /** Creates the edge parameters by combining the downwards-flowing and upwards-flowing parameters for edges that connect to this node.
    *
  ...
  /** Create an edge coming inwards into this node.
    *
    *  By default just calls [[edge]].
    */
  ...
  extends InwardNodeHandle[DI, UI, EI, BI] with OutwardNodeHandle[DO, UO, EO, BO]
{
  ...
  /** Connects a full node with an output => an output handle.
    *
    * <---< := <---x  ==  <---x
...
trait InwardNode[DI, UI, BI <: Data] extends BaseNode
{
  ...
  /** Downwards-flowing parameters.
    *
    * Generated from the nodes connected to the inward side of this node.
    */
  protected[diplomacy] val diParams: Seq[DI]

  /** Upwards-flowing parameters.
    *
    * Generated by this node and sent to the nodes connected to the inward side of this node.
    */
...
/** The sealed Node in the package, all node are derived from it.
  ...
  * @tparam DI Downwards-flowing parameters received on the inner side of the node.
...
/** EphemeralNodes are used as temporary connectivity placeholders, but disappear from the final node graph.
