...
abstract class BaseNode(implicit val valName: ValName)
{
  ...
  /** Mark whether the node represents an identity function over the parameters moving through it.
    *
    * This information may be used to elide monitors or inline the parent module,
    * since it indicates that the circuitry generated by this node should have no consequence.
    */
