  ...
  lazy val module = new LazyModuleImp(this) {
    ...
    val (d_wb_lanes, d_wb_poison) = Seq
      .tabulate(lanes) { i =>
        ...
        (upd.orR || d_correctable(i), (!upd.andR && d_uncorrectable(i)) || d_poison) // sub-lane writes should not correct uncorrectable
      }
      .unzip
    ...
    val a_data = Vec(Seq.tabulate(lanes) { i =>
    ...
    val a_lanes = Seq.tabulate(lanes) { i =>
