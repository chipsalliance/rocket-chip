...
class TLMonitor(args: TLMonitorArgs, monitorDir: MonitorDirection = MonitorDirection.Monitor) extends TLMonitorBase(args)
{
  ...
  def legalizeFormatA(bundle: TLBundleA, edge: TLEdge) {
    ...
    when (bundle.opcode === TLMessages.AcquireBlock) {
      monAssert (edge.expectsAcquireBMasterToSlaveSafe(bundle.source, edge.address(bundle), bundle.size), "'A' channel carries AcquireBlock type unsupported by manager" + extra)
    ...
    when (bundle.opcode === TLMessages.AcquirePerm) {
      monAssert (edge.expectsAcquireBMasterToSlaveSafe(bundle.source, edge.address(bundle), bundle.size), "'A' channel carries AcquirePerm type unsupported by manager" + extra)
    ...
    when (bundle.opcode === TLMessages.Get) {
      monAssert (edge.expectsAcquireBMasterToSlaveSafe(bundle.source, edge.address(bundle), bundle.size), "'A' channel carries Get type unsupported by manager" + extra)
    ...
    when (bundle.opcode === TLMessages.PutFullData) {
      monAssert (edge.expectsPutFullMasterToSlaveSafe(bundle.source, edge.address(bundle), bundle.size), "'A' channel carries PutFull type unsupported by manager" + extra)
    ...
    when (bundle.opcode === TLMessages.PutPartialData) {
      monAssert (edge.expectsPutPartialMasterToSlaveSafe(bundle.source, edge.address(bundle), bundle.size), "'A' channel carries PutPartial type unsupported by manager" + extra)
    ...
    when (bundle.opcode === TLMessages.ArithmeticData) {
      monAssert (edge.expectsArithmeticMasterToSlaveSafe(bundle.source, edge.address(bundle), bundle.size), "'A' channel carries Arithmetic type unsupported by manager" + extra)
    ...
    when (bundle.opcode === TLMessages.LogicalData) {
      monAssert (edge.expectsLogicalMasterToSlaveSafe(bundle.source, edge.address(bundle), bundle.size), "'A' channel carries Logical type unsupported by manager" + extra)
    ...
    when (bundle.opcode === TLMessages.Hint) {
      monAssert (edge.expectsHintMasterToSlaveSafe(bundle.source, edge.address(bundle), bundle.size), "'A' channel carries Hint type unsupported by manager" + extra)
  ...
  def legalizeFormatB(bundle: TLBundleB, edge: TLEdge) {
    ...
    when (bundle.opcode === TLMessages.Probe) {
      monAssert (edge.expectsProbeSlaveToMaster(bundle.source, bundle.size), "'B' channel carries Probe type unsupported by client" + extra)
    ...
    when (bundle.opcode === TLMessages.Get) {
      monAssert (edge.expectsVipCheckerSlaveToMasterPutFull(bundle.source, bundle.size), "'B' channel carries Get type unsupported by client" + extra)
    ...
    when (bundle.opcode === TLMessages.PutFullData) {
      monAssert (edge.expectsVipCheckerSlaveToMasterPutFull(bundle.source, bundle.size), "'B' channel carries PutFull type which is unexpected using diplomatic parameters" + extra)
    ...
    when (bundle.opcode === TLMessages.PutPartialData) {
      monAssert (edge.expectsVipCheckerSlaveToMasterPutPartial(bundle.source, bundle.size), "'B' channel carries PutPartial type which is unexpected using diplomatic parameters" + extra)
    ...
    when (bundle.opcode === TLMessages.ArithmeticData) {
      monAssert (edge.expectsVipCheckerSlaveToMasterArithmetic(bundle.source, bundle.size), "'B' channel carries Arithmetic type unsupported by master" + extra)
    ...
    when (bundle.opcode === TLMessages.LogicalData) {
      monAssert (edge.expectsVipCheckerSlaveToMasterLogical(bundle.source, bundle.size), "'B' channel carries Logical type unsupported by client" + extra)
    ...
    when (bundle.opcode === TLMessages.Hint) {
      monAssert (edge.expectsVipCheckerSlaveToMasterHint(bundle.source, bundle.size), "'B' channel carries Hint type unsupported by client" + extra)
  ...
  def legalizeFormatC(bundle: TLBundleC, edge: TLEdge) {
    ...
    when (bundle.opcode === TLMessages.Release) {
      monAssert (edge.expectsVipCheckerMasterToSlaveAcquireB(edge.address(bundle), bundle.size), "'C' channel carries Release type unsupported by manager" + extra)
      monAssert (edge.expectsVipCheckerSlaveToMasterProbe(edge.source(bundle), bundle.size), "'C' channel carries Release from a client which does not support Probe" + extra)
    ...
    when (bundle.opcode === TLMessages.ReleaseData) {
      monAssert (edge.expectsVipCheckerMasterToSlaveAcquireB(edge.address(bundle), bundle.size), "'C' channel carries ReleaseData type unsupported by manager" + extra)
      monAssert (edge.expectsVipCheckerSlaveToMasterProbe(edge.source(bundle), bundle.size), "'C' channel carries Release from a client which does not support Probe" + extra)
