...
class InstructionDecoder(p: InstructionDecoderParameter) {
  ...
  object selAlu1 extends UOPDecodeField[RocketDecodePattern] {
    ...
    override def genTable(op: RocketDecodePattern): BitPat = op.instruction.name match {
      ...
      case i if Seq("add", "addi", "addiw", "addw", "amoadd.d", "amoadd.w", "amoand.d", "amoand.w", "amomax.d", "amomax.w", "amomaxu.d", "amomaxu.w", "amomin.d", "amomin.w", "amominu.d", "amominu.w", "amoor.d", "amoor.w", "amoswap.d", "amoswap.w", "amoxor.d", "amoxor.w", "and", "andi", "beq", "bge", "bgeu", "blt", "bltu", "bne", "cdiscard.d.l1", "cflush.d.l1", "csrrc", "csrrs", "csrrw", "czero.eqz", "czero.nez", "div", "divu", "divuw", "divw", "fcvt.d.l", "fcvt.d.lu", "fcvt.d.w", "fcvt.d.wu", "fcvt.h.l", "fcvt.h.lu", "fcvt.h.w", "fcvt.h.wu", "fcvt.s.l", "fcvt.s.lu", "fcvt.s.w", "fcvt.s.wu", "fld", "flh", "flw", "fmv.d.x", "fmv.h.x", "fmv.w.x", "fsd", "fsh", "fsw", "hfence.gvma", "hfence.vvma", "hlv.b", "hlv.bu", "hlv.d", "hlv.h", "hlv.hu", "hlv.w", "hlv.wu", "hlvx.hu", "hlvx.wu", "hsv.b", "hsv.d", "hsv.h", "hsv.w", "jalr", "lb", "lbu", "ld", "lh", "lhu", "lr.d", "lr.w", "lw", "lwu", "mul", "mulh", "mulhsu", "mulhu", "mulw", "or", "ori", "rem", "remu", "remuw", "remw", "sb", "sc.d", "sc.w", "sd", "sfence.vma", "sh", "sll", "slli", "slliw", "sllw", "slt", "slti", "sltiu", "sltu", "sra", "srai", "srai", "sraiw", "sraw", "srl", "srli", "srli", "srliw", "srlw", "sub", "subw", "sw", "xor", "xori").contains(i) => UOPA1.rs1
  ...
  object selAlu2 extends UOPDecodeField[RocketDecodePattern] {
    ...
    override def genTable(op: RocketDecodePattern): BitPat = op.instruction.name match {
      ...
      case i if Seq("add", "addw", "and", "beq", "bge", "bgeu", "blt", "bltu", "bne", "czero.eqz", "czero.nez", "div", "divu", "divuw", "divw", "mul", "mulh", "mulhsu", "mulhu", "mulw", "or", "rem", "remu", "remuw", "remw", "sll", "sllw", "slt", "sltu", "sra", "sraw", "srl", "srlw", "sub", "subw", "xor").contains(i) => UOPA2.rs2
