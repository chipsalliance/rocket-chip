...
/**
  * @todo check encode optimization.
  */
trait MemoryOpConstants {
  ...
  def M_X       = BitPat("b?????")
  /** int load */
  def M_XRD     = UInt("b00000")
  /** int store */
  def M_XWR     = UInt("b00001")
  /** prefetch with intent to read. */
  def M_PFR     = UInt("b00010")
  /** prefetch with intent to write. */
  def M_PFW     = UInt("b00011")
  def M_XA_SWAP = UInt("b00100")
  /** flush all lines */
  def M_FLUSH_ALL = UInt("b00101")
