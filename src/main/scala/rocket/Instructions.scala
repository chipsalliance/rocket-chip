...
object Instructions {
  ...
  def VMFORD_VF          = BitPat("b011010???????????101?????1010111")
  ...
  def VMFORD_VV          = BitPat("b011010???????????001?????1010111")
  ...
  def VWSMACCSU_VX       = BitPat("b111110???????????100?????1010111")
  def VWSMACCUS_VX       = BitPat("b111111???????????100?????1010111")
  ...
  def VWSMACCSU_VV       = BitPat("b111110???????????000?????1010111")
  ...
  def VWMACCSU_VV        = BitPat("b111110???????????010?????1010111")
  ...
  def VWMACCSU_VX        = BitPat("b111110???????????110?????1010111")
  def VWMACCUS_VX        = BitPat("b111111???????????110?????1010111")
