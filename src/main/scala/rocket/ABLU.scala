...
class ABLU(implicit p: Parameters) extends CoreModule()(p) {
  ...
  val (pla_in, pla_out) = pla(Seq(
    ...
    (BitPat("b100011"),BitPat("b00_010_0000_000_0011 0001 00_0000_0000_1000_0000")),//FN_MAXU
    (BitPat("b100100"),BitPat("b00_001_0000_000_0011 0001 00_0000_0000_1000_0000")),//FN_MIN
