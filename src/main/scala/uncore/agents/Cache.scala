...
class L2HellaCacheBank(clockSignal: Clock = null, resetSignal: Bool = null)(implicit p: Parameters)
    extends HierarchicalCoherenceAgent(clockSignal, resetSignal)(p) with HasOuterCacheParameters {
