...
abstract class AbstractOuterMemorySystem(clockSignal: Clock = null, resetSignal: Bool = null)(implicit val p: Parameters)
...
class DummyOuterMemorySystem(clockSignal: Clock = null, resetSignal: Bool = null)(implicit p: Parameters)
    extends AbstractOuterMemorySystem(clockSignal, resetSignal)(p) {
...
/** The whole outer memory hierarchy, including a NoC, some kind of coherence
  ...
  */ 
class OuterMemorySystem(clockSignal: Clock = null, resetSignal: Bool = null)(implicit p: Parameters)
    extends AbstractOuterMemorySystem(clockSignal, resetSignal)(p) {
