    ...
    r.copy(rocc =
      Seq(
        RoCCParams(
          ...
          generator = (masterNode, p: Parameters) => Module(new AccumulatorExample()(p))),
        RoCCParams(
          opcodes = OpcodeSet.custom1,
          generator = (masterNode, p: Parameters) => Module(new TranslatorExample()(p)),
          nPTWPorts = 1),
        RoCCParams(
          opcodes = OpcodeSet.custom2,
          generator = (masterNode, p: Parameters) => Module(new CharacterCountExample()(p))))) }
