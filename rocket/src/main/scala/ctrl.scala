...
class Control extends Module
{
  ...
  io.imem.btb_update.valid := io.dpath.mem_misprediction && ((mem_ctrl.branch && io.dpath.mem_br_taken) || mem_ctrl.jalr || mem_ctrl.jal) && !take_pc_wb
  ...
  io.imem.ras_update.bits.isCall := mem_ctrl.wen && io.dpath.mem_waddr(0)
